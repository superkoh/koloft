...
**Rejected**: a cleanup that clears the flag. Two reviews asked for it; it writes false
then true on every input change and runs the hint queue twice for nothing.
