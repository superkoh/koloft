...
function listingPastNodeDefaultMaxBuffer(prefix: string): string {
...
beforeAll(() => {
  ...
  fs.writeFileSync(files.trk, listingPastNodeDefaultMaxBuffer('trk'))
  fs.writeFileSync(files.oth, listingPastNodeDefaultMaxBuffer('oth'))
  fs.writeFileSync(files.ign, listingPastNodeDefaultMaxBuffer('ign'))
...
// PLATFORM§27
describe('A-07: search survives a git listing bigger than the 1 MB default maxBuffer', () => {
