...
// §4.3 (the list behind BB-M16) — what the task field offers after you type `/`.
// The fs is injected, so a whole made-up disk is one object literal here.

const WS = '/ws-a'
const HOME = '/home/me'

/** a tiny disk: keys are paths, a string is a file, an array is a folder */
